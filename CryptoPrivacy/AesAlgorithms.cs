...
namespace CryptoPrivacy
{
    public class AesAlgorithms
    {
        ...
        public static void DecryptFile(string theEncryptedFile, string passwordfromtextbox)
        {
        ...
        public static string AesTextDecryption(string DataToDecrypt, string KeyToDecryptWith, string IVKeyToDecryptWith)
        {
