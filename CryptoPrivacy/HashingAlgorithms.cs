...
namespace CryptoPrivacy
{
    ...
    {
        public string HashingMD5(string TextToHash)
        {
        ...
        public string HashingSHA1(string TextToHash)
        {
        ...
        public string HashingSHA256(string TextToHash)
        {
        ...
        public string HashingSHA384(string TextToHash)
        {
        ...
        public string HashingSHA512(string TextToHash)
        {
        ...
        public string FileHashingSHA512(string FilePath)
        {
        ...
        public string FileHashingSHA384(string FilePath)
        {
            FileStream GetFileToHash = new FileStream(FilePath, FileMode.Open);
        ...
        public string FileHashingSHA256(string FilePath)
        {
            FileStream GetFileToHash = new FileStream(FilePath, FileMode.Open);
        ...
        public string FileHashingSHA1(string FilePath)
        {
            FileStream GetFileToHash = new FileStream(FilePath, FileMode.Open);
        ...
        public string FileHashingMD5(string FilePath)
        {
            FileStream GetFileToHash = new FileStream(FilePath, FileMode.Open);
        ...
        public string HashingHMACMD5(string TextToHash, string Key)
        {
        ...
        public string HashingHMACSHA1(string TextToHash, string Key)
        {
            string KeyToHashWith = Key;
            byte[] KeyToHash = Encoding.ASCII.GetBytes(KeyToHashWith);
        ...
        public string HashingHMACSHA384(string TextToHash, string Key)
        {
            string KeyToHashWith = Key;
            byte[] KeyToHash = Encoding.ASCII.GetBytes(KeyToHashWith);
        ...
        public string HashingHMACSHA512(string TextToHash, string Key)
        {
            string KeyToHashWith = Key;
            byte[] KeyToHash = Encoding.ASCII.GetBytes(KeyToHashWith);
